...
class PressImagePin(models.Model):
    press_item = models.ForeignKey(PressItem, related_name='pins')
    pinid = models.CharField(max_length=255)
    sort_order = models.PositiveIntegerField(_('sort order'))

    class Meta:
        verbose_name = _("press pin")
        verbose_name_plural = _("press pins")
        ordering = ['-sort_order', ]
